...
"data":{"filterFields":{}, "pageInfo":{}, "arcId":"11", "dmaId":"2", "presszoneId":"3", "sectorId":"3", "dqaId":"1"}}$$);
...
--  Set search path to local schema
    ...
    IF v_grafdelim = 'CHECKVALVE' THEN
		...
		INSERT INTO audit_check_data (fid, criticity, error_message) VALUES (359,1, 
		concat('and set to_arc of config_mincut_checkvalve for node ', v_feature_id, ' with value ',v_arc_id, '.'));
