...
(sector_id, "name", macrosector, sector_type, descript, parent_id, pattern_id, graphconfig, stylesheet, link, avg_press, undelete, tstamp, insert_user, lastupdate, lastupdate_user, the_geom)
