...
--  Get element
    v_sql := 'SELECT layer_id, orderby , add_param->>''geomType'' as geomtype FROM  '||quote_ident(v_config_layer)||' WHERE layer_id = any('||quote_literal(v_visiblelayer)||'::text[]) UNION 
