...
BEGIN 
    ...
    orphannode_delete_aux = (SELECT "value" FROM config_param_system WHERE "parameter"='orphannode_delete');

    -- Delete orphan nodes
    IF orphannode_delete_aux THEN
