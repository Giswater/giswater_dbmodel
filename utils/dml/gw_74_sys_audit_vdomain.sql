...
INSERT INTO audit_cat_function VALUES (2320, 'gw_fct_repair_arc_searchnodes', 'Network repair', 'cur_user, expl_id', 'arc, node', 'Massive repair function. All the arcs that are not connected with extremal node will be reconected using the parameter arc_searchnodes (from config_param_system table)', NULL, NULL, NULL);
...
INSERT INTO audit_cat_function VALUES (2230, 'gw_fct_repair_arc_searchnodes', 'Network repair', 'cur_user, expl_id', 'arc, node', 'Massive repair function. All the arcs that are not connected with extremal node will be reconected using the parameter arc_searchnodes (from config_param_system table)', NULL, NULL, NULL);
