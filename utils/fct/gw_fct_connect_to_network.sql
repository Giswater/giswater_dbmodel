		...
		IF v_exit.the_geom IS NOT NULL THEN
			...
			IF v_feature_type ='CONNEC' THEN
				...
				IF v_autoupdate_dma IS FALSE THEN
					UPDATE connec SET arc_id=v_connect.arc_id, expl_id=v_arc.expl_id, sector_id=v_arc.sector_id, pjoint_type=v_pjointtype, pjoint_id=v_pjointid
			...
			ELSIF v_feature_type ='GULLY' THEN 
				...
				IF v_autoupdate_dma IS FALSE THEN
					UPDATE gully SET arc_id=v_connect.arc_id, expl_id=v_arc.expl_id, sector_id=v_arc.sector_id, pjoint_type=v_pjointtype, pjoint_id=v_pjointid
