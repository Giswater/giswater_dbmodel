...
DROP VIEW IF EXISTS ve_ui_visit_x_node CASCADE;
...
DROP VIEW IF EXISTS ve_ui_visit_x_arc CASCADE;
...
DROP VIEW IF EXISTS ve_ui_visit_x_connec CASCADE;
...
SELECT DISTINCT ON (ve_ui_visit_x_node.visit_id) ve_ui_visit_x_node.visit_id,
    ve_ui_visit_x_node.code,
    om_visit_cat.name AS visitcat_name,
    ve_ui_visit_x_node.node_id,
    date_trunc('second'::text, ve_ui_visit_x_node.visit_start) AS visit_start,
    date_trunc('second'::text, ve_ui_visit_x_node.visit_end) AS visit_end,
    ve_ui_visit_x_node.user_name,
    ve_ui_visit_x_node.is_done,
    ve_ui_visit_x_node.feature_type,
    ve_ui_visit_x_node.form_type
    FROM ve_ui_visit_x_node
    JOIN om_visit_cat ON om_visit_cat.id = ve_ui_visit_x_node.visitcat_id;
  

CREATE OR REPLACE VIEW v_ui_om_visitman_x_arc AS 
SELECT DISTINCT ON (ve_ui_visit_x_arc.visit_id) ve_ui_visit_x_arc.visit_id,
    ve_ui_visit_x_arc.code,
    om_visit_cat.name AS visitcat_name,
    ve_ui_visit_x_arc.arc_id,
    date_trunc('second'::text, ve_ui_visit_x_arc.visit_start) AS visit_start,
    date_trunc('second'::text, ve_ui_visit_x_arc.visit_end) AS visit_end,
    ve_ui_visit_x_arc.user_name,
    ve_ui_visit_x_arc.is_done,
    ve_ui_visit_x_arc.feature_type,
    ve_ui_visit_x_arc.form_type
    FROM ve_ui_visit_x_arc
    JOIN om_visit_cat ON om_visit_cat.id = ve_ui_visit_x_arc.visitcat_id;



CREATE OR REPLACE VIEW v_ui_om_visitman_x_connec AS 
 SELECT DISTINCT ON (ve_ui_visit_x_connec.visit_id) ve_ui_visit_x_connec.visit_id,
    ve_ui_visit_x_connec.code,
    om_visit_cat.name AS visitcat_name,
    ve_ui_visit_x_connec.connec_id,
    date_trunc('second'::text, ve_ui_visit_x_connec.visit_start) AS visit_start,
    date_trunc('second'::text, ve_ui_visit_x_connec.visit_end) AS visit_end,
    ve_ui_visit_x_connec.user_name,
    ve_ui_visit_x_connec.is_done,
    ve_ui_visit_x_connec.feature_type,
    ve_ui_visit_x_connec.form_type
    FROM ve_ui_visit_x_connec
    JOIN om_visit_cat ON om_visit_cat.id = ve_ui_visit_x_connec.visitcat_id;
...
DROP VIEW IF EXISTS  "ve_ui_visit" CASCADE;
...
DROP VIEW IF EXISTS ve_ui_event CASCADE; 
