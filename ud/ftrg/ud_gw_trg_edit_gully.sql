...
BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
		...
		IF v_matfromcat THEN
			...
			groove=NEW.groove, connec_arccat_id=NEW.connec_arccat_id, connec_depth=NEW.connec_depth, siphon=NEW.siphon, sector_id=NEW.sector_id,
		...
		if new.label_x != old.label_x and new.label_y != old.label_y then
			...
			update gully set label_x = new.label_x, label_y = new.label_y where gully_id = new.gully_id;
