...
BEGIN
	...
	IF v_count > 0 THEN
		...
		VALUES (v_fid, v_result_id, 2, concat('ERROR: There is/are ',v_count,' node''s orphan. Giswater filters may prevent export, if they are JUNCTION will be disabled on the exportation.'));
	ELSE
		INSERT INTO audit_check_data (fid, result_id, criticity, error_message)
	...
	RAISE NOTICE '12 - Topological nodes with epa_type NOT DEFINED (379)';
