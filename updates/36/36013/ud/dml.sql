...
ELSE 0 END as feature_id, ''GULLY'' as type, gratecat_id as featurecat,the_geom, expl_id FROM gully', info_msg='All features with id integer.', function_name='[gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=543, fprocess_name='Gully chain with different arc_id than the final connec/gully', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check om-data', addparam=NULL, except_level=NULL, except_msg='chained connecs/gullys without links or gullies over arc without arc_id.', except_msg_feature=NULL, query_text='with c as (
...
UNION SELECT element_id as id, a.state, state_type FROM v_prefix_element a JOIN value_state_type b ON id=state_type WHERE a.state <> b.state', info_msg='No features without concordance against state and state_type.', function_name='[gw_fct_om_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=547, fprocess_name='Check fluid_type values exists on man_ table', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check om-data', addparam=NULL, except_level=3, except_msg='features with fluid_type does not exists on man_type_fluid table.', except_msg_feature=NULL, query_text='SELECT ''ARC'', arc_id, fluid_type FROM v_prefix_arc WHERE fluid_type NOT IN (SELECT fluid_type FROM man_type_fluid WHERE feature_type is null or feature_type = ''ARC'' or featurecat_id IS NOT NULL) AND fluid_type IS NOT NULL
UNION
...
UNION SELECT gully_id as feature_id from v_prefix_gully where state = 1 and enddate is not null', info_msg='No features on service have value of end date', function_name='[gw_fct_om_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=564, fprocess_name='Check orphan documents', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Function process', addparam=NULL, except_level=2, except_msg='documents not related to any feature.', except_msg_feature=NULL, query_text='select id from doc where id not in (
...
UNION SELECT element_id, elementcat_id, the_geom FROM v_prefix_element WHERE code IS NULL', info_msg='No features (arc, node, connec, element, gully) with NULL values on code found.', function_name='[gw_fct_om_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=554, fprocess_name='Features state=0 without end date', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check om-data', addparam=NULL, except_level=2, except_msg='features with state 0 without value of end date.', except_msg_feature=NULL, query_text='SELECT arc_id as feature_id from v_prefix_arc where state = 0 and enddate is null
...
UNION SELECT gully_id from v_prefix_gully where state = 0 and enddate is null', info_msg='No features with state 0 are missing the end date', function_name='[gw_fct_om_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=555, fprocess_name='Check connecs with more than 1 link on service', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check om-data', addparam=NULL, except_level=2, except_msg='connecs with more than 1 link on service', except_msg_feature=NULL, query_text='SELECT connec_id, connecat_id, the_geom, expl_id FROM v_prefix_connec WHERE connec_id 
...
IN (SELECT feature_id FROM link WHERE state=1 GROUP BY feature_id HAVING count(*) > 1)', info_msg='No connects with more than 1 link on service', function_name='[gw_fct_om_check_data, gw_fct_pg2epa_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=556, fprocess_name='Check orphan visits', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Function process', addparam=NULL, except_level=2, except_msg='visits not related to any feature and without geometry.', except_msg_feature=NULL, query_text='select id, the_geom from om_visit where the_geom is null and id not in (
with mec as (
...
)', info_msg='All visits are related to the features or have geometry.', function_name='[gw_fct_om_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=557, fprocess_name='Builddate before 1900', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check om-data', addparam=NULL, except_level=2, except_msg='features with built date before 1900.', except_msg_feature=NULL, query_text='SELECT arc_id, ''ARC''::text FROM v_prefix_arc WHERE builtdate < ''1900/01/01''::date
UNION 
...
UNION SELECT gully_id from v_prefix_gully where enddate < builtdate and state = 1', info_msg='No features with end date earlier than built date', function_name='[gw_fct_om_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=567, fprocess_name='Check features without defined sector_id', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check om-data', addparam=NULL, except_level=2, except_msg='connecs with sector_id 0 or -1.', except_msg_feature=NULL, query_text='SELECT connec_id, connecat_id, the_geom, expl_id FROM v_prefix_connec WHERE state > 0 AND (sector_id=0 OR sector_id=-1)
UNION SELECT gully_id, gratecat_id, the_geom, expl_id FROM v_prefix_gully WHERE state > 0 AND (sector_id=0 OR sector_id=-1)', info_msg='No connecs with 0 or -1 value on sector_id.', function_name='[gw_fct_om_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=568, fprocess_name='Check category_type values exists on man_ table', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check om-data', addparam=NULL, except_level=3, except_msg='features with category_type does not exists on man_type_category table.', except_msg_feature=NULL, query_text='SELECT ''ARC'', arc_id, category_type FROM v_prefix_arc WHERE category_type NOT IN (SELECT category_type FROM man_type_category WHERE feature_type is null or feature_type = ''ARC'' or featurecat_id IS NOT NULL) AND category_type IS NOT NULL
UNION
...
UNION
SELECT 295, a.arc_id, a.arccat_id, concat(epa_type, '' using inp_virtual table'') AS epa_table, a.the_geom FROM v_edit_inp_virtual JOIN arc a USING (arc_id) WHERE epa_type !=''VIRTUAL''', info_msg='Epa type for arcs features checked. No inconsistencies aganints epa table found.', function_name='[gw_fct_pg2epa_check_data]';
UPDATE sys_fprocess SET fid=571, fprocess_name='Arcs less than 20 cm.', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check epa-topology', addparam=NULL, except_level=2, except_msg='pipes with length less than node proximity distance configured.', except_msg_feature=NULL, query_text='SELECT * FROM v_edit_inp_conduit WHERE st_length(the_geom) < (SELECT value::json->>''value'' FROM config_param_system WHERE parameter = ''edit_node_proximity'')::float', info_msg='Standard minimun length checked. No values less than node proximity distance configured.', function_name='[gw_fct_pg2epa_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=572, fprocess_name='arcs less than 5 cm.', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check epa-topology', addparam=NULL, except_level=3, except_msg='conduits with length less than configured minimum length.', except_msg_feature=NULL, query_text='SELECT the_geom, st_length(the_geom) AS length FROM v_edit_inp_conduit WHERE st_length(the_geom) < (SELECT value FROM config_param_system WHERE parameter = ''epa_arc_minlength'')::float', info_msg='Critical minimun length checked. No values less than configured minimum length found.', function_name='[gw_fct_pg2epa_check_data, gw_fct_admin_check_data]';
UPDATE sys_fprocess SET fid=528, fprocess_name='Check outlet_id existance in inp_subcatchment and inp_junction', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check epa-data', addparam=NULL, except_level=3, except_msg='non-existing outlet_id related to subcatchment.', except_msg_feature=NULL, query_text='select outlet_id from v_edit_inp_subc2outlet
LEFT JOIN (
...
where outlet_type = ''SUBCATCHMENT'' and s.subc_id is null', info_msg='All subcatchments have an existing outlet_id', function_name='[gw_fct_pg2epa_check_data]';
UPDATE sys_fprocess SET fid=583, fprocess_name='Missing data on inp tables', project_type='ud', parameters=NULL, "source"='core', isaudit=true, fprocess_type='Check epa-data', addparam=NULL, except_level=3, except_msg='missed features on inp tables. Please, check your data before continue', except_msg_feature=NULL, query_text='SELECT arc_id, ''arc'' as feature_tpe FROM arc JOIN
