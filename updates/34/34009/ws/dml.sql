...
-- make sure to on next INSERT id field will be the same as descript
UPDATE _anl_mincut_cat_cause_ SET id=descript;
...
--update mincut_cause from old idval to new numeric id
UPDATE om_mincut m SET anl_cause=t.id FROM om_typevalue t WHERE t.idval=m.anl_cause AND typevalue='mincut_cause';
