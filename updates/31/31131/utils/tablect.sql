...
ALTER TABLE om_team_x_vehicle ADD CONSTRAINT om_team_x_vehicle_team_id_fkey FOREIGN KEY (team_id) REFERENCES cat_team (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE om_team_x_vehicle ADD CONSTRAINT om_team_x_vehicle_vehicle_id_fkey FOREIGN KEY (vehicle_id) REFERENCES ext_cat_vehicle (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE RESTRICT;
