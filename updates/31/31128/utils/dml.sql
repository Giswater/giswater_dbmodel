...
VALUES ('plan_psector_statetype', '{"done_planified":"9", "done_ficticious":"18", "canceled_planified":"17", "canceled_ficticious":"18"}', 'json', 'plan', 
'Psector statetype assigned to features after executing or canceling planification');

INSERT INTO config_param_system(parameter, value, data_type, context, descript)
VALUES ('plan_statetype_planned', '11', 'integer', 'plan', 'State type for planned elements');

UPDATE config_param_system SET value='15' WHERE parameter='plan_statetype_ficticius';
