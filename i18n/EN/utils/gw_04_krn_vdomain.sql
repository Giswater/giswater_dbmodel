...
INSERT INTO sys_csv2pg_cat (id, name, name_i18n, csv_structure, sys_role) VALUES (1, 'Import db prices', 'Import db prices', 'The csv file must contains next columns on same position: id, unit, descript, text, price. 
...
INSERT INTO sys_csv2pg_cat (id, name, name_i18n, csv_structure, sys_role) VALUES (2, 'Import node visit table', 'Import node visit table', 'The csv file must contains next columns on same position: node_id, unit', 'role_om');
INSERT INTO sys_csv2pg_cat (id, name, name_i18n, csv_structure, sys_role) VALUES (3, 'Import elements', 'Import elements', 'The csv file must containts next columns on same position: feature_id, elementcat_id, observ, comment, num_elements. 
...
INSERT INTO sys_csv2pg_cat (id, name, name_i18n, csv_structure, sys_role) VALUES (4, 'Import addfields', 'Import addfields', 'The csv file must containts next columns on same position: 
